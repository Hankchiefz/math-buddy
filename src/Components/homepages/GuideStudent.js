  ...
  return (
    <div className="student-guide">
      <div className="student-guide-header">
        <h1 className="student-guide-title">Students, Welcome to MathBuddy!</h1>
      </div>
      <div className="student-guide-content">
        <p className="student-guide-text">
        ...
        <h2 className="student-guide-subtitle">Exploring your Student Dashboard:</h2>
        <p className="student-guide-text">
        ...
        <h3 className="student-guide-section">1. Quizzes:</h3>
        ...
        <h3 className="student-guide-section">2. Lessons:</h3>
        <p className="student-guide-text">
        ...
        <h3 className="student-guide-section">3. Feedback:</h3>
        <ul className="student-guide-list">
          <li>
        ...
        <h3 className="student-guide-section">4. Learning Resources:</h3>
        <p className="student-guide-text">
        ...
        <h3 className="student-guide-section">5. Active tasks:</h3>
        <p className="student-guide-text">
        ...
        <h3 className="student-guide-section">6. Recently Accessed:</h3>
        <p className="student-guide-text">
        ...
        <h3 className="student-guide-section">7. Profile:</h3>
        <p className="student-guide-text">
        ...
        <p className="student-guide-conclusion">
